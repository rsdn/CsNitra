...
- [✅] T4.4.1 Правило, пропускающее строки вне препроцессорских директив (CodeLine через правила, не ручной скан)
- [✅] T4.4.2 Пропуск комментариев в нём через TriviaTerminal основного парсера
- [✅] T4.4.3 Пропуск строковых литералов через правила основного парсера (CSharpGrammar: Cs6/Cs11.grammar)
